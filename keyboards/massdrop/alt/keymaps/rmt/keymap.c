...
enum alt_keycodes {
    ...
    DBG_MOU,            //DEBUG Toggle Mouse Printss
    MD_BOOT,            //Restart into bootloader after hold timeout

    C_SWAP_GA,     //Set swapped state for LGUI and LALT
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_CAPS,   KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
    [1] = LAYOUT(
        ...
        _______, L_PTP,   L_BRD,   L_PTN,   _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_VOLU, \
        _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, TG_NKRO, _______, _______, _______, _______, _______,          _______, KC_VOLD, \
        _______, C_SWAP_GA, _______,                            _______,                            _______, L_T_PTD, KC_MPRV, KC_MPLY, KC_MNXT  \
    ),
    /*
    [X] = LAYOUT(
